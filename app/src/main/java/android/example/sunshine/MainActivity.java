package android.example.sunshine;
...
import android.example.sunshine.data.WeatherContract;
import android.example.sunshine.sync.SunshineSyncUtils;
...
import android.example.sunshine.data.SunshinePreferences;
import android.example.sunshine.utilities.NetworkUtils;
import android.example.sunshine.utilities.OpenWeatherJsonUtils;
...
public class MainActivity extends AppCompatActivity implements
    ...
    /**
     * Called by the {@link androidx.loader.content.CursorLoader} when a new Loader needs to be
